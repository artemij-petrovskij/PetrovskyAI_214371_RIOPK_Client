        ...
        <v-fade-transition>
            ...
            <v-btn to="/edit-advert">Comfortable Button</v-btn> -->
                    <v-card title="Добавить компанию (общие сведения)" class="mx-auto" max-width="700"
                        ...
                        <v-container class="align-center ">
                            ...
                            <v-form ref="form1" v-model="valid" lazy-validation @submit.prevent="submitForm">
                                ...
                                <v-text-field v-model="name" label="Название категории" :rules="[rules.required]"
                                    hide-details required>
                                </v-text-field>
                                <v-text-field v-model="description" label="Описание, подразделы"
                    ...
                    <v-card class="mx-auto mt-4" max-width="700" variant="outlined">
                        ...
                        <v-card title="Список категорий" class="mx-auto" max-width="700">
                            <v-list lines="one">
    ...
    methods: {
        ...
        async createAdv() {
            if (this.name != null && this.description != null) {
                ...
                let response = await Vacancy.createCategory(data);
                if (response.err) {
                    this.snackbar = true;
